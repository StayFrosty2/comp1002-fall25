...
/* Cameron Note: FOR THE LIFE OF ME I could not figure out how to get the document.getElementById to work since we didn't learn it in class, so I just decided to do it with document.querySelector instead and it worked.*/
const blockGallery = document.querySelector("#blockGallery");
